...
// Redirect hook driven by useSession. SessionProvider is server-seeded, so `status` is resolved on
// first render. No client organizer/admin gate — those routes are gated on the server.
